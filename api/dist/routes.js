...
routes.post('/sale', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, consumerObject, productsArray, couponObject, saleMessage;
        ...
        switch (_a.label) {
            case 0:
                ...
                productsArray = function () {
                    var receivedProducts = req.body.products.length;
                    var products = [];
                    for (var i = 0; i < receivedProducts; i++) {
                ...
                return [4 /*yield*/, req.producer.send({
                        topic: 'issue-sales',
                        messages: [
                            {
